...
$ helm repo update
$ helm search repo chgl/fhir-server-exporter --version=1.0.8
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.8
```
...
```bash
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.8 --set fetchIntervalSeconds=300
```
...
```bash
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.8 --values values.yaml
```
