...
$ helm repo update
$ helm search repo chgl/fhir-server-exporter --version=1.0.15
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.15
```
...
```bash
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.15 --set fetchIntervalSeconds=300
```
...
```bash
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.15 --values values.yaml
```
