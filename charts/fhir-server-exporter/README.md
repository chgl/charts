...
$ helm repo update
$ helm search repo chgl/fhir-server-exporter --version=0.4.5
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=0.4.5
```
...
```bash
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=0.4.5 --set fetchIntervalSeconds=300
```
...
```bash
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=0.4.5 --values values.yaml
```
