...
$ helm repo update
$ helm search repo chgl/fhir-server-exporter --version=1.0.10
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.10
```
...
```bash
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.10 --set fetchIntervalSeconds=300
```
...
```bash
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.10 --values values.yaml
```
