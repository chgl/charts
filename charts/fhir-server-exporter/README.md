...
$ helm repo update
$ helm search repo chgl/fhir-server-exporter --version=1.0.1
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.1
```
...
```bash
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.1 --set fetchIntervalSeconds=300
```
...
```bash
$ helm upgrade -i fhir-server-exporter chgl/fhir-server-exporter -n fhir --create-namespace --version=1.0.1 --values values.yaml
```
