...
| postgres.enabled                                     | enable an included PostgreSQL DB. if set to `false`, the values under `webApi.db` are used                                                                                                                                                                                                                                                    | <code>true</code>                                                                                                                                                                       |
| postgres.auth.enablePostgresUser                     |                                                                                                                                                                                                                                                                                                                                               | <code>false</code>                                                                                                                                                                      |
| postgres.auth.database                               |                                                                                                                                                                                                                                                                                                                                               | <code>"ohdsi"</code>                                                                                                                                                                    |
| postgres.auth.username                               |                                                                                                                                                                                                                                                                                                                                               | <code>"ohdsi"</code>                                                                                                                                                                    |
...
| webApi.serviceAccount.create                         | Specifies whether a service account should be created.                                                                                                                                                                                                                                                                                        | <code>true</code>                                                                                                                                                                       |
| webApi.serviceAccount.name                           | The name of the service account to use. If not set and create is true, a name is generated using the fullname template                                                                                                                                                                                                                        | <code>""</code>                                                                                                                                                                         |
| webApi.serviceAccount.automountServiceAccountToken   | whether to automount the SA token                                                                                                                                                                                                                                                                                                             | <code>false</code>                                                                                                                                                                      |
...
| webApi.db.host                                       | database hostname of an external database. Only used if `postgresql.enabled` is set to `false`.                                                                                                                                                                                                                                               | <code>"host.example.com"</code>                                                                                                                                                         |
...
| webApi.auth.basic.query                              | SQL query used to fetch entries in the basic security table by their username. Requires a table called `basic_security_users` to exist within the above schema, see [kitchen-sink-test-values.yamll](ci/kitchen-sink-test-values.yaml) for an example DB setup. Evaluated as a template.                                                      | <code>>-&#13;&#10; SELECT password, first_name AS firstname, middle_name AS middlename, last_name AS lastname, username FROM basic_security_users WHERE username = ?</code>             |
...
| webApi.resourcesPreset                               | set container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if primary.resources is set (primary.resources is recommended for production). More information: <https://github.com/bitnami/charts/blob/main/bitnami/common/templates/_resources.tpl#L15> | <code>"large"</code>                                                                                                                                                                    |
| webApi.metrics.serviceMonitor.enabled                | if enabled, creates a ServiceMonitor instance for Prometheus Operator-based monitoring this also implicitly enables the OpenTelemetry Java agent and exposes its metrics port note that this overrides the `JAVA_OPTS` environment variable with `"-javaagent:/var/lib/ohdsi/webapi/opentelemetry-javaagent.jar"`                             | <code>false</code>                                                                                                                                                                      |
| webApi.tracing.enabled                               | if enabled, export traces to the specified endpoint. this also implicitly enables the OpenTelemetry Java agent by setting the `JAVA_OPTS` environment variable to `"-javaagent:/var/lib/ohdsi/webapi/opentelemetry-javaagent.jar"`                                                                                                            | <code>false</code>                                                                                                                                                                      |
| webApi.tracing.jaeger.protocol                       | specify the transport protocol. Sets the `OTEL_EXPORTER_JAEGER_PROTOCOL` env var                                                                                                                                                                                                                                                              | <code>"grpc"</code>                                                                                                                                                                     |
| webApi.tracing.jaeger.endpoint                       | full URL of the Jaeger HTTP endpoint. Sets the `OTEL_EXPORTER_JAEGER_ENDPOINT` env var                                                                                                                                                                                                                                                        | <code>http://simplest-collector.observability.svc:14250 # http://localhost:14250</code>                                                                                                 |
| webApi.tracing.jaeger.agentHost                      | hostname of the Jaeger agenr. Sets the `OTEL_EXPORTER_JAEGER_AGENT_HOST` env var                                                                                                                                                                                                                                                              | <code>localhost</code>                                                                                                                                                                  |
| webApi.tracing.jaeger.agentPort                      | udp/thrift.compact port of the Jaeger agent. Sets the `OTEL_EXPORTER_JAEGER_AGENT_PORT` env var                                                                                                                                                                                                                                               | <code>6831</code>                                                                                                                                                                       |
...
| atlas.serviceAccount.create                          | Specifies whether a service account should be created.                                                                                                                                                                                                                                                                                        | <code>true</code>                                                                                                                                                                       |
| atlas.serviceAccount.name                            | The name of the service account to use. If not set and create is true, a name is generated using the fullname template                                                                                                                                                                                                                        | <code>""</code>                                                                                                                                                                         |
| atlas.serviceAccount.automountServiceAccountToken    | whether to automount the SA token                                                                                                                                                                                                                                                                                                             | <code>false</code>                                                                                                                                                                      |
...
| atlas.resourcesPreset                                | set container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if primary.resources is set (primary.resources is recommended for production). More information: <https://github.com/bitnami/charts/blob/main/bitnami/common/templates/_resources.tpl#L15> | <code>"small"</code>                                                                                                                                                                    |
...
| cdmInitJob.image                                     | the container image used to create the CDM initialization job                                                                                                                                                                                                                                                                                 | <code>{"pullPolicy":"IfNotPresent","registry":"docker.io","repository":"docker/whalesay","tag":"latest@sha256:178598e51a26abbc958b8a2e48825c90bc22e641de3d31e18aaf55f3258ba93b"}</code> |
| cdmInitJob.backoffLimit                              | the number of retries before considering the Job as failed                                                                                                                                                                                                                                                                                    | <code>6</code>                                                                                                                                                                          |
| cdmInitJob.restartPolicy                             | restartPolicy of the job <https://kubernetes.io/docs/concepts/workloads/controllers/job/#handling-pod-and-container-failures>                                                                                                                                                                                                                 | <code>Never</code>                                                                                                                                                                      |
...
| cdmInitJob.resourcesPreset                           | set container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if primary.resources is set (primary.resources is recommended for production). More information: <https://github.com/bitnami/charts/blob/main/bitnami/common/templates/_resources.tpl#L15> | <code>"medium"</code>                                                                                                                                                                   |
...
| achilles.serviceAccount.create                       | Specifies whether a service account should be created.                                                                                                                                                                                                                                                                                        | <code>true</code>                                                                                                                                                                       |
| achilles.serviceAccount.name                         | The name of the service account to use. If not set and create is true, a name is generated using the fullname template                                                                                                                                                                                                                        | <code>""</code>                                                                                                                                                                         |
| achilles.serviceAccount.automountServiceAccountToken | whether to automount the SA token                                                                                                                                                                                                                                                                                                             | <code>false</code>                                                                                                                                                                      |
...
| achilles.resourcesPreset                             | set container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if primary.resources is set (primary.resources is recommended for production). More information: <https://github.com/bitnami/charts/blob/main/bitnami/common/templates/_resources.tpl#L15> | <code>"small"</code>                                                                                                                                                                    |
| ingress.enabled                                      | whether to create an Ingress to expose the Atlas web interface                                                                                                                                                                                                                                                                                | <code>false</code>                                                                                                                                                                      |
| loadCohortDefinitionsJob.enabled                     | whether to enable a job for loading custom cohort definitions in JSON format <br> WARNING: the job doesn't load the cohort definitions idempotently, so it is likely for definitions to appear multiple times if the job is run multiple times                                                                                                | <code>false</code>                                                                                                                                                                      |
| loadCohortDefinitionsJob.restartPolicy               | restartPolicy of the job <https://kubernetes.io/docs/concepts/workloads/controllers/job/#handling-pod-and-container-failures>                                                                                                                                                                                                                 | <code>Never</code>                                                                                                                                                                      |
| loadCohortDefinitionsJob.backoffLimit                | the number of retries before considering the Job as failed                                                                                                                                                                                                                                                                                    | <code>1</code>                                                                                                                                                                          |
| loadCohortDefinitionsJob.ttlSecondsAfterFinished     | clean up Job and dependent objects after job completion <https://kubernetes.io/docs/concepts/workloads/controllers/job/#ttl-mechanism-for-finished-jobs>                                                                                                                                                                                      | <code>120</code>                                                                                                                                                                        |
| loadCohortDefinitionsJob.resourcesPreset             | set container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if primary.resources is set (primary.resources is recommended for production). More information: <https://github.com/bitnami/charts/blob/main/bitnami/common/templates/_resources.tpl#L15> | <code>"micro"</code>                                                                                                                                                                    |
...
| initContainers.resourcesPreset                       | set container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if primary.resources is set (primary.resources is recommended for production). More information: <https://github.com/bitnami/charts/blob/main/bitnami/common/templates/_resources.tpl#L15> | <code>"micro"</code>                                                                                                                                                                    |

Specify each parameter using the `--set key=value[,key=value]` argument to `helm install`. For example:

```sh
helm install ohdsi oci://ghcr.io/chgl/charts/ohdsi -n ohdsi --set postgres.auth.database="ohdsi"
```
