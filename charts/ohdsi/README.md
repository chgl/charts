...
$ helm repo update
$ helm install ohdsi chgl/ohdsi -n ohdsi --version=0.16.1
```
...
```console
$ helm install ohdsi chgl/ohdsi -n ohdsi --version=0.16.1 --set postgresql.auth.database="ohdsi"
```
...
```console
$ helm install ohdsi chgl/ohdsi -n ohdsi --version=0.16.1 --values values.yaml
```
