...
$ helm repo update
$ helm install ohdsi chgl/ohdsi -n ohdsi --version=0.15.2
```
...
```console
$ helm install ohdsi chgl/ohdsi -n ohdsi --version=0.15.2 --set postgresql.auth.database="ohdsi"
```
...
```console
$ helm install ohdsi chgl/ohdsi -n ohdsi --version=0.15.2 --values values.yaml
```
