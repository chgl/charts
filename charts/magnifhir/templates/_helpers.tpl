...
Common labels
*/}}
{{- define "magnifhir.labels" -}}
helm.sh/chart: {{ include "magnifhir.chart" . }}
{{ include "magnifhir.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "magnifhir.selectorLabels" -}}
