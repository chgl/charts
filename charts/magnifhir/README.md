...
$ helm repo update
$ helm search repo chgl/magnifhir --version=1.0.5
$ helm upgrade -i magnifhir chgl/magnifhir -n magnifhir --create-namespace --version=1.0.5
```
...
```bash
$ helm upgrade -i magnifhir chgl/magnifhir -n magnifhir --create-namespace --version=1.0.5 --set replicaCount=1
```
...
```bash
$ helm upgrade -i magnifhir chgl/magnifhir -n magnifhir --create-namespace --version=1.0.5 --values values.yaml
```
